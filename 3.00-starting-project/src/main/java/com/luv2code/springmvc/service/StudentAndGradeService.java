...
public class StudentAndGradeService {
	...
	private MathGrade mathGrade;  //prototype bean created in MvcTestingExampleApplication
	...
	private ScienceGrade scienceGrade;  //prototype bean created in MvcTestingExampleApplication
	...
	private HistoryGrade historyGrade;  //prototype bean created in MvcTestingExampleApplication
	...
	public boolean createGrade(double grade,int studentId , String gradeType) {
		...
		//If student doesn't exist then return false, we can't create a grade for a student who doesn't exist
	...
	public GradebookCollegeStudent studentInformation(int id) {
		...
		mathGrades.forEach(mathGradesList::add); //added each grade in iterable to list
